        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 p-4">
            <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md text-center border border-slate-200">
                ...
                <button
                    ...
                    className="w-full bg-slate-800 hover:bg-slate-700 text-white font-semibold py-3 px-4 rounded-lg flex items-center justify-center gap-3 transition-colors"
                >
                ...
                <p className="mt-8 text-xs text-slate-400">
                    Access is restricted strictly to authorized organization emails.
                </p>
            </div>
        </div>
    );
